...
setInterval(myFunction, 6000); 
   ...
   $('img').each(function(){
			...
			$this.attr('src',$this.attr('src').replace('https://anywhereanycity.com/fashion','https://anywhereanycity.com/fashion/public'));
			$this.attr('src',$this.attr('src').replace('/public/public/','/public/'));
	})
	
	 var fullimage = $('#file_details_url').val();
	 var newimage = fullimage.replace('https://anywhereanycity.com/fashion','https://anywhereanycity.com/fashion/public'); 
	 var newimage = newimage.replace('/public/public/','/public/'); 
	 $('#file_details_url').val(newimage);
} 
});	
