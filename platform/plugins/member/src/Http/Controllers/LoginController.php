...
class LoginController extends Controller
{
    ...
    */
    ...
    public function login(Request $request)
    {
		 ...
		 //print_r($findUser);
		//echo Auth::guard('member')->login($findUser);
		 //echo auth('member')->login($findUser);
		 auth('member')->login($findUser);		 
    ...
    public function logout(Request $request)
    {
        ...
        return $this->loggedOut($request) ?: redirect('https://anywhereanycity.com/home/user-logout');
    }
}
