  ...
  <div class="container">
    ...
    <!-- Right Side Of Navbar -->
      <ul class="navbar-nav ml-auto my-2">
              <a class="no-underline mr2 black-50 hover-black-70 pv1 ph2 db mr2" style="text-decoration: none; line-height: 32px;" href="/fashion" title="{{ trans('plugins/member::dashboard.header_settings_link') }}">
              Fashion Home
            </a>
          </li>
            ...
            <a class="no-underline mr2 black-50 hover-black-70 pv1 ph2 db mr2" style="text-decoration: none; line-height: 32px;" href="{{ route('public.member.dashboard') }}" title="{{ trans('plugins/member::dashboard.header_profile_link') }}">
              <span>
                <!--<img src="{{ auth('member')->user()->avatar_url }}" class="br-100 v-mid mr1" style="width: 30px; height: 30px">-->
				 ...
				 <img id="profile_pic" src="" alt="Avatar" class="br-100" style="width: 30px; height: 30px"><span>{{ auth('member')->user()->name }}</span>
              </span>
            </a>
          </li>
          <li>
